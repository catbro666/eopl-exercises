#lang eopl
; Exercise 3.15 [*] Extend the language by adding a new operation `print` that takes one argument, prints it,
; and returns the integer 1. Why is this operation not expressible in our specification framework?

; It has effect that can't be expressed by the spec
...
; test
;> (run "print(cons(1, cons(zero?(0), cons(v, emptylist))))")
;(1 #t 5)
;#(struct:num-val 1)