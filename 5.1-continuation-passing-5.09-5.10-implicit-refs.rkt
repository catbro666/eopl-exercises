#lang eopl
; Continuation-Passing Interpreter (based on 5.08 version)

;Exercise 5.9 [**] Modify this interpreter to implement the IMPLICIT-REFS language.
;As a hint, consider including a new continuation-builder (set-rhs-cont env var cont).
;Exercise 5.10 [**] Modify the solution to the previous exercise so that the environment is not kept
;in the continuation.
