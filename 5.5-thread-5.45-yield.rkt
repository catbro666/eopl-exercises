#lang eopl
; Thread (based on Exercise 5.4-thread-0-base)
; Exercise 5.45 [*] Add to the language of this section a construct called yield.
; Whenever a thread executes a yield, it is placed on the ready queue, and the thread at the
...
(define (value-of-program timeslice pgm)
  ...
  (cases program pgm
    (a-program (exp1)
               (trampoline (value-of/k exp1 (init-env) (end-main-thread-cont))))))
