#lang eopl
; Continuation-Passing Interpreter (based on 5.10 version)

;Exercise 5.11 [**] Add the begin expression of exercise 4.4 to the continuationpassing interpreter.
;Be sure that no call to value-of or value-of-rands occurs in a position that would build control context.
