#lang eopl
; Mutable Pairs (Based on 4.27 version)

; Add new expressed value: MutPair. We implement mpair/left/right/setleft/setright as primitives but not keywords
; Note we didn't add datatype Pair/MutPair for simplicity. We can add them if necessary.

;ExpVal  = Int+Bool+Null+Pair+Proc+Void+Subr+MutPair
