#lang eopl
; Thread (based on Exercise 5.46)
; Exercise 5.51 [***] We would like to be able to organize our program so that
;the consumer in figure 5.17 doesn’t have to busy-wait. Instead, it should be able to
;put itself to sleep and be awakened when the producer has put a value in the buffer.
;Either write a program with mutexes to do this, or implement a synchronization operator
